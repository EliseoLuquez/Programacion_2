...
namespace RPP
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            emisores.Add(new EmisorDeEmails("3 meses gratis de servicio de monitoreo.", Emisor.EProducto.MonitoringApp, "pepito@pepe.pepe"));
            EmisorDeWhatsapp emisorWhatsapp = new EmisorDeWhatsapp("Usted ha adquirido servicio de Azure SQL Base de Datos", Emisor.EProducto.SQLDatabase);
